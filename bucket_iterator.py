...
class BucketIterator(object):
    ...
    def pad_data(self, batch_data):
        ...
        for item in batch_data:
            ...
            batch_distance_graph.append(numpy.pad(distance_graph,
                ((0,max_len-len(text_indices)),(0,max_len-len(text_indices))), 'constant'))
            batch_ef_graph.append(numpy.pad(ef_graph,
                ((0,max_len-len(text_indices)),(0,max_len-len(text_indices))), 'constant'))
        ...
        return { \
                ...
                'distance_graph': torch.tensor(batch_distance_graph), \
                'ef_graph': torch.tensor(batch_ef_graph),
            }
