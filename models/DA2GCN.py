...
class DA2GCN(nn.Module):
    def __init__(self, embedding_matrix, opt):
        super(DA2GCN, self).__init__()
        self.opt = opt
    ...
    def forward(self, inputs):
        text_indices, aspect_indices, left_indices, adj, ltp = inputs
        ...
        # encoder_layer, pooled_output = self.bert(text_indices, token_type_ids=bert_segments_ids,
        ...
        y = F.relu(self.gc1(self.position_weight(text_out, aspect_double_idx, text_len, aspect_len), ltp))
        y = F.relu(self.gc2(self.position_weight(y, aspect_double_idx, text_len, aspect_len), ltp))
        # y = F.relu(self.gc3(self.position_weight(y, aspect_double_idx, text_len, aspect_len), ltp))
        # y = F.relu(self.gc4(self.position_weight(y, aspect_double_idx, text_len, aspect_len), ltp))
        # y = F.relu(self.gc5(self.position_weight(y, aspect_double_idx, text_len, aspect_len), ltp))
        # y = F.relu(self.gc6(self.position_weight(y, aspect_double_idx, text_len, aspect_len), ltp))
