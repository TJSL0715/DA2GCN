...
from models import LSTM, DA2GCN
        ...
        for epoch in range(self.opt.num_epoch):
            ...
            for i_batch, sample_batched in enumerate(self.train_data_loader):
                ...
                if global_step % self.opt.log_step == 0:
                    ...
                    n_total += len(outputs)
                    train_acc = n_correct / n_total  # 准确率
...
if __name__ == '__main__':
    ...
    parser.add_argument('--model_name', default='DA2GCN', type=str)
    parser.add_argument('--dataset', default='douban', type=str, help='twitter, rest14, lap14, rest15, rest16')
    ...
    input_colses = {
        'lstm': ['text_indices'],
        'DA2GCN': ['text_indices', 'aspect_indices', 'left_indices', 'distance_graph', 'ef_graph'],
    }
    initializers = {
